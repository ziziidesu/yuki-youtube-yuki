...
max_api_wait_time = 3
max_time = 10
api = ast.literal_eval(requests.get('https://raw.githubusercontent.com/justaweidro/yahoo-inv/main/instances.txt').text)
...
app.mount("/search", StaticFiles(directory="./blog", html=True), name="static")
